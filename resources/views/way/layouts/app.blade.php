...
<head>
	...
	<!-- Document title -->
	<!-- Stylesheets & Fonts -->
	<link href="{{ asset(env('THEME')) }}/css/plugins.css" rel="stylesheet">
	<link href="{{ asset(env('THEME')) }}/css/style.css" rel="stylesheet">
	<link href="{{ asset(env('THEME')) }}/css/custom.css" rel="stylesheet">
	<link href="{{ asset(env('THEME')) }}/css/xxx.css" rel="stylesheet">
</head>
