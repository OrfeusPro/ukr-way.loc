                ...
                <div class="col-lg-12 font-14">
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-12 p-0 hb_form xs-pt xxs-pt-mobile xxs-pb">
                            ...
                            <input type="text" id="otkuda" name="otkuda" placeholder="Пункт отправления" list="routes" required>
                            <datalist id="routes">
                        ...
                        <div class="col-lg-2 col-md-2 col-12 p-0 hb_form xs-pt xxs-pt-mobile xxs-pb">
                            ...
                            <input type="text" id="kuda" name="kuda" placeholder="Пункт прибытия" list="routes2" required>
                            <datalist id="routes2">
								@foreach ($dist_r_to as $to)
									<option value="{{ $to->r_to }}">
								@endforeach
                        ...
                        <div class="col-lg-2 col-md-2 col-12 p-0 hb_form xs-pt xxs-pt-mobile xxs-pb">
                            ...
                            <input type="text" class="" id="name" name="name" placeholder="Имя клиента" required>
                        </div>
                        <div class="col-lg-2 col-md-2 col-12 p-0 hb_form xs-pt xxs-pt-mobile xxs-pb">
                            <label class="uk-form-label" for="form-stacked-text">НОМЕР ТЕЛЕФОНУ</label>
                            <input type="tel" class="" id="phone" name="phone" placeholder="___ ___ __ __" required>
                        </div>

                        <div class="col-lg-2 col-md-2 col-12 p-0 hb_form xs-pt xxs-pt-mobile xxs-pb">
                            <label class="uk-form-label" for="form-stacked-text">ДАТА</label>
                            <input type="date" name="date" id="nowdate" class="hb-input"  placeholder="__/__/____" required>
                        </div>
